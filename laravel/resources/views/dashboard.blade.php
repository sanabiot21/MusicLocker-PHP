...
<section class="py-5" style="margin-top: 80px;">
    <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="text-end d-none d-md-block">
                        <div class="text-muted small">
                            ...
                            Last login: {{ $user->last_login ? $user->last_login->format('M j, Y g:i A') : 'First time!' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="feature-card">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('profile.edit') }}" class="btn btn-sm btn-outline-glow">
        ...
        <div class="row">
            <div class="col-12">
                @if(($userStats['total_entries'] ?? 0) == 0)
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="p-4 rounded" style="background: rgba(0, 212, 255, 0.1); border: 1px solid rgba(0, 212, 255, 0.2);">
                                                ...
                                                <a href="{{ route('music.create') }}" class="btn btn-glow">Get Started</a>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="p-4 rounded" style="background: rgba(138, 43, 226, 0.1); border: 1px solid rgba(138, 43, 226, 0.2);">
                                                ...
                                                <a href="{{ route('music.create') }}" class="btn btn-outline-glow">Search & Add</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="activity-item">
                                        ...
                                        <div class="activity-content">
                                            <div class="activity-header">
                                                ...
                                                <small class="text-muted">{{ $activity['timestamp']->format('M j, g:i A') }}</small>
                                            </div>
