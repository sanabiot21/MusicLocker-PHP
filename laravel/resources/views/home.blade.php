...
@section('title', 'Music Locker - Your Personal Music Universe')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3">
                        @guest
                            <a href="{{ route('register') }}" class="btn btn-glow btn-lg px-4 py-3">
                        ...
                        @else
                            <a href="{{ route('dashboard') }}" class="btn btn-glow btn-lg px-4 py-3">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                        @guest
                            <a href="{{ route('register') }}" class="btn btn-glow btn-lg px-5">
                                <i class="bi bi-person-plus me-2"></i>Create Free Account
                            </a>
                            <a href="{{ route('login') }}" class="btn btn-outline-glow btn-lg px-5">
                                <i class="bi bi-box-arrow-in-right me-2"></i>Sign In
                            </a>
                        @else
                            <a href="{{ route('dashboard') }}" class="btn btn-glow btn-lg px-5">
                                <i class="bi bi-speedometer2 me-2"></i>Go to Dashboard
                            </a>
                        @endguest
                    </div>
        ...
        <div class="container">
            <div class="row text-center g-4">
                <div class="col-md-3 col-sm-6">
                    <div class="stat-item">
                        <div class="stat-number" style="color: var(--accent-blue);">{{ number_format($stats['active_users'] ?? 0) }}</div>
                        <div class="stat-label text-muted">Active Users</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="stat-item">
                        <div class="stat-number" style="color: var(--accent-purple);">{{ number_format($stats['songs_cataloged'] ?? 0) }}</div>
                        <div class="stat-label text-muted">Songs Cataloged</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="stat-item">
                        <div class="stat-number" style="color: var(--accent-blue);">{{ number_format($stats['personal_notes'] ?? 0) }}</div>
                        <div class="stat-label text-muted">Personal Notes</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="stat-item">
                        <div class="stat-number" style="color: var(--accent-purple);">{{ number_format($stats['mood_tags_created'] ?? 0) }}</div>
